  ...
  if(isset($_SESSION["shopping_cart"]))  
     {  
      $item_array_id = array_column($_SESSION["shopping_cart"], "item_id");  
           ...
           {     
                echo '<script>window.location="rowtextile.php"</script>';  
           }  
      }  
      else  
      {  
...
<?php echo $success;?>
	...
	<div class="col-xs-4">
		<h3 id="services"  class="text-center title">Flat Sheet (ጥሬ ጨርቅ)</h3>
			 <div>
				 <div class="w3-content w3-section" style="max-width:550px;padding-left: 0px;height:40%">
					 <img class="mySlides" src="images/flat_sheet/flat_sheet1.png" style="width:100%">
					 <img class="mySlides" src="images/flat_sheet/flat_sheet2.jpg" style="width:100%">
				 </div>
				 <script>
				 var myIndex = 0;
				 carousel();
	...
	<?php $result = mysql_query("SELECT * FROM product WHERE Product_Model='lgt006'");
...
<form method="post" action="rowtextile.php?action=add&id=<?php echo $row["id"]; ?>">
...
<img style="margin-left:20px" src="images/shoppingcart.png"/></a>
	...
	<p><h1><span style="font-size: 15pt;"><strong><i>Key features</i></strong></span></h1>
	<ul style="list-style:none;">
	<li  class="list"> Has a pronounced luster that makes it look beautiful on your body</li>
	<li  class="list">Renewable material (cotton)</li>
	<li  class="list">Cotton feels soft and nice against your skin</li>
	<li  class="list">Plain woven bed set cotton is very soft and pleasant</li>
	<li  class="list">cotton cellulose keeps you dry and comfortable all through</li>
	...
	<p><h1><span style="font-size: 15pt;"><strong><i>Package:- large size</i></strong></span></h1>Width: 9.36 " (24 cm)<br />Height: 8.2" (21 cm)<br />Length: 14.43&rdquo; (37 cm)</p>
	<p><h1><span style="font-size: 15pt;"><strong><i>People &amp; Planet</i></strong></span></h1></p>
	...
	<p><h1><span style="font-size: 15pt;"><strong><i>Includes:</i></strong></span></h1></p>
	...
	<p><h1><span style="font-size: 15pt;"><strong><i>Care instructions</i></strong></span></h1>Machine wash, hot 140&deg;F (60&deg;C).<br />Close the zipper before washing.<br />Do not bleach.<br />Tumble dry, normal.&nbsp;<br />Do not dry clean.<br />Product description<br />100 % cotton</p></p>
					</div>
