  ...
  if(isset($_SESSION["shopping_cart"]))  
     {  
      $item_array_id = array_column($_SESSION["shopping_cart"], "item_id");  
           ...
           {     
                echo '<script>window.location="kuta.php"</script>';  
           }  
      }  
      else  
      {  
...
<?php echo $success;?>
	...
	<div class="col-xs-4">
		<h3 id="services"  class="text-center title">Kuta  (ጋቢ/ኩታ/ነጠላ)</h3>
			 <div>
	...
	<?php $result = mysql_query("SELECT * FROM product WHERE Product_Model='lgt002'");
...
<form method="post" action="kuta.php?action=add&id=<?php echo $row["id"]; ?>">
...
<img style="margin-left:20px" src="images/shoppingcart.png"/></a>
	...
	<li  class="list">Plain woven bed set cotton is very soft and pleasant to wear</li>
