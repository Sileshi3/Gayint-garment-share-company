  ...
  if(isset($_SESSION["shopping_cart"]))  
     {  
      $item_array_id = array_column($_SESSION["shopping_cart"], "item_id");  
           ...
           {     
                echo '<script>window.location="bedsheet.php"</script>';  
           }  
      }  
      else  
      {  
...
<div class="tab-pane fade active in" id="order" style="width:100%">
	<div class="col-xs-4">
		<h3 id="services"  class="text-center title">Bed Sheet  (አንሶላ)</h3>
			 <div>
				 <div class="w3-content w3-section" style="max-width:550px;padding-left: 0px;height:100%">
					 <img class="mySlides" src="images/bedsheet/bedsheet1.png" style="width:100%">
					 <img class="mySlides" src="images/bedsheet/bedsheet2.jpg" style="width:100%">
					 <img class="mySlides" src="images/bedsheet/bedsheet3.jpg" style="width:100%">
					 <img class="mySlides" src="images/bedsheet/bedsheet4.jpg" style="width:100%">
					 <img class="mySlides" src="images/bedsheet/bedsheet5.jpg" style="width:100%">
				 </div>
				 <script>
				 var myIndex = 0;
				 carousel();
	...
	<?php $result = mysql_query("SELECT * FROM product WHERE Product_Model='lgt005'");
                if(mysql_num_rows($result) > 0)  
               {  
                     while($row = mysql_fetch_array($result))  
                     {  
                ?> 
      <div class="col-xs-4 no-left-right" style="margin-bottom: 30px; ">
<form method="post" action="bedsheet.php?action=add&id=<?php echo $row["id"]; ?>">
...
<select name="SelectColor" value="white" style="font-size: 16px margin-top:20px margin-top:40px">
