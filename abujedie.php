  ...
  if(isset($_SESSION["shopping_cart"]))  
     {  
      $item_array_id = array_column($_SESSION["shopping_cart"], "item_id");  
           ...
           {     
                echo '<script>window.location="abujedie.php"</script>';  
           }  
      }  
      else  
      {  
...
<div class="tab-pane fade active in" id="order" style="width:100%">
	<div class="col-xs-4">
		<h3 id="services"  class="text-center title">Abujedie  (አቡጀዴ)</h3>
			 <div>
				 <div class="w3-content w3-section" style="max-width:550px;padding-left: 0px;height:40%">
					 <img class="mySlides" src="images/abujedie/abu1.jpg" style="width:100%">
					 <img class="mySlides" src="images/abujedie/abu2.jpg" style="width:100%">
					 <img class="mySlides" src="images/abujedie/abu3.jpg" style="width:100%">
					 <img class="mySlides" src="images/abujedie/abu1.jpg" style="width:100%">
				 </div>
				 <script>
				 var myIndex = 0;
	...
	<?php $result = mysql_query("SELECT * FROM product WHERE Product_Model='lgt004'");
...
<form method="post" action="abujedie.php?action=add&id=<?php echo $row["id"]; ?>">
...
<div class="discription" style="border-bottom:">
 ...
 <li  class="list">Cotton feels soft</li>
 <li  class="list">Very comfortable for painting </li>
<li  class="list">cotton cellulose keeps you dry and comfortable</li>
